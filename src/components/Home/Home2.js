        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              Welcome to my portfolio! I'm Manikanta Vinjamuri, a passionate and
              dedicated full-stack web developer with a keen eye for crafting
              elegant and functional digital experiences with a strong
              ...
              <i>
                <b className="purple">
                  {" "}
                  Javascript, ReactsJS, NodeJS(ExpressJS), MySQL{" "}
                </b>
              </i>
              <br />
              <br />
              My field's of Interest is &nbsp;
              <i>
                <b className="purple">Full Stack Web Developement </b>
              </i>
              <br />
              <br />
